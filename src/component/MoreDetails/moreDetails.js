    ...
    <>
      ...
      <section>
        <div className="fixedd">
          <Link to="/MovieDetail">
            <div className="relatedd">Related</div>
          </Link>

          <div className="dett">Details</div>
        </div>

        <div className="detailss-container">
          <h5>More Info</h5>
          <h5>Content advisory</h5>
          <p>Violence, sexual content, foul language, alcohol use</p>
          <h5>Audio languages</h5>
          <p> हिंदी</p>
          <h5>Subtitiles</h5>
          <p>
            English, Francais, Bahasa Melayu (bruei), Bahasa Melayu (malaysia)
          </p>
          <h5>Directors</h5>
          <div className="atag">
            <a href="/">Karan Johar</a>
          </div>
          <h5>Producers</h5>
          <div className="atag">
            <a href="/">
              Karan Johar, Hiroo Johar, Apoorva Mehta, Somen Mishra, Digvijay
              Purohit, Ajay Sharma, Navmeet Singh
            </a>
          </div>
          <h5>Starring</h5>
          <p>Dharmendra, Java Bachachan, Shabana Azmi</p>
          <h5>Studio</h5>
          <p>Dharama Productions, Viacom 18 Motion Pictures</p>
          <p>
            By clicking play, you agree to our <a href="/">Terms of Use</a>
          </p>
          <div className="bot-bod">
            <h5>Feedback</h5>
